...
if __name__ == "__main__":
    filtered_titles = {'我将巡征追猎', '梦境', '这就是我啦', '黄金与机械', '寰宇蝗灾', '忍法帖缭乱破魔', '我的诞生', '烦恼着幸福着', '汪散步时间', '现实', '开拓者同谐', '账账',
                       '片刻留在眼底', '舞舞舞', '开拓者存护', '光锥', '忍事录音律狩猎', '白日梦酒店', '模拟宇宙', '开拓者毁灭', '托帕', '阮梅', '点个关注吧', '丹恒饮月', '琥珀', '嘿我在这儿', '三月七巡猎'}
