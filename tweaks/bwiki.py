...
if __name__ == "__main__":
    filtered_titles = {"「我」的诞生", "「白日梦」酒店-梦境", "「白日梦」酒店-现实", "三月七•巡猎", "丹恒•饮月", "嘿，我在这儿", "开拓者•同谐", "开拓者•存护", "开拓者•毁灭", "忍事录•音律狩猎", "忍法帖•缭乱破魔",
                       "我将，巡征追猎", "托帕&账账", "模拟宇宙：寰宇蝗灾", "模拟宇宙：黄金与机械", "汪！散步时间！", "点个关注吧！", "烦恼着，幸福着", "片刻，留在眼底", "琥珀（光锥）", "舞！舞！舞！", "这就是我啦！", "阮•梅"}
